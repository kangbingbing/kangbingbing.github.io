...
1.  安装Homebrew;
2.  如果没有安装输入以下命令安装ruby -e "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install)"
3.  brew tap homebrew/nginx;
...
6.  修改配置文件, 终端输入brew info nginx-full;
...
8.  把路径复制下, finder前往文件夹, 粘贴路径打开, 如图:![](https://ws1.sinaimg.cn/large/9e1008a3ly1fe3igvrsiij20od0il0ut.jpg)
9.  在上图位置添加如下代码:
...
url 里192.168.1.115 是电脑本机的地址 1935 就是我们上面 Nginx 的第9步, listen,  填写正确即可开始直播; 
